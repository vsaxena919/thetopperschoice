...
<ul class="nav">
    ...
    <li <?php if($pagename == 'configurations') { echo 'class="active selected"'; } ?>>
        <a href="configurations.php"><i class="oi oi-calendar"></i> <span class="nav-label">General Settings</span></a>
    </li>
    ...
    <li <?php if($pagename == 'help') { echo 'class="active selected"'; } ?>>
        <a href="help.php"><i class="oi oi-question-mark"></i> <span class="nav-label">Help / Support</span></a>
    </li>
</ul>
<!-- END Site Navigation -->
