...
<html>
    ...
    <body>
        <!-- Pen Title-->
        <div class="pen-title">
            <h1>C`O`D`E`L`I`S`T`.`C`C` - </h1><span>PHP Login Script by <a href='http://www.angry-frog.com'>Angry Frog</a></span>
        </div>
        <!-- Form Module-->
        ...
        <div class="text-muted text-center" id="login-footer">
            <small><span id="year-copy">2016</span> © <a href="http://www.angry-frog.com" target="_blank">Angry Frog</a></small>
        </div>
